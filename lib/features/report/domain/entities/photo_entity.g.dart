...
PhotoEntity _photoEntityDeserialize(
  ...
  final object = PhotoEntity(
    ...
    status:
        _PhotoEntitystatusValueEnumMap[reader.readStringOrNull(offsets[9])] ??
...
extension PhotoEntityQueryFilter
  ...
  QueryBuilder<PhotoEntity, PhotoEntity, QAfterFilterCondition> hashCodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hashCode',
  ...
  QueryBuilder<PhotoEntity, PhotoEntity, QAfterFilterCondition> hashCodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PhotoEntityQuerySortBy
  ...
  QueryBuilder<PhotoEntity, PhotoEntity, QAfterSortBy> sortByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<PhotoEntity, PhotoEntity, QAfterSortBy> sortByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PhotoEntityQuerySortThenBy
  ...
  QueryBuilder<PhotoEntity, PhotoEntity, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<PhotoEntity, PhotoEntity, QAfterSortBy> thenByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.desc);
    });
  }
...
extension PhotoEntityQueryWhereDistinct
  ...
  QueryBuilder<PhotoEntity, PhotoEntity, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
...
extension PhotoEntityQueryProperty
  ...
  QueryBuilder<PhotoEntity, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
