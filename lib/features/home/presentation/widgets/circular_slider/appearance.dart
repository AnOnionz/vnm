...
class CircularSliderAppearance {
  ...
  Widget? get _topLabel => infoProperties?.topLabel;
  Widget? get _bottomLabel => infoProperties?.bottomLabel;
  ...
  Widget get infoTopLabel {
    return _topLabel ?? SizedBox();
  }

  Widget get infoBottomLabel {
    return _bottomLabel ?? SizedBox();
  }
...
class InfoProperties {
  ...
  InfoProperties(
      {this.topLabel, this.mainLabelStyle, this.bottomLabel, this.modifier});
}
