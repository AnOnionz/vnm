...
const EmployeeUserEntitySchema = Schema(
  name: r'EmployeeUserEntity',
  id: 1223110144548796001,
  properties: {
  ...
  estimateSize: _employeeUserEntityEstimateSize,
  serialize: _employeeUserEntitySerialize,
  deserialize: _employeeUserEntityDeserialize,
  deserializeProp: _employeeUserEntityDeserializeProp,
);

int _employeeUserEntityEstimateSize(
  EmployeeUserEntity object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _employeeUserEntitySerialize(
  EmployeeUserEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _employeeUserEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension EmployeeUserEntityQueryFilter
    on QueryBuilder<EmployeeUserEntity, EmployeeUserEntity, QFilterCondition> {
...
extension EmployeeUserEntityQueryObject
    on QueryBuilder<EmployeeUserEntity, EmployeeUserEntity, QFilterCondition> {}
