...
mixin Fx {
  ...
  static EdgeInsets p0 = EdgeInsets.zero;
  static EdgeInsets p1 = const EdgeInsets.all(dp1);
  static EdgeInsets p2 = const EdgeInsets.all(dp2);
  static EdgeInsets p4 = const EdgeInsets.all(dp4);
  static EdgeInsets p8 = const EdgeInsets.all(dp8);
  static EdgeInsets p12 = const EdgeInsets.all(dp12);
  static EdgeInsets p16 = const EdgeInsets.all(dp16);
  static EdgeInsets p20 = const EdgeInsets.all(dp20);
  static EdgeInsets p24 = const EdgeInsets.all(dp24);
  static EdgeInsets p32 = const EdgeInsets.all(dp32);
  static EdgeInsets p48 = const EdgeInsets.all(dp48);
  static EdgeInsets p64 = const EdgeInsets.all(dp64);

  /// Symmetric Fixed EdgeInsets
  static const pV0 = EdgeInsets.symmetric();
  static const pH0 = EdgeInsets.symmetric();
  static const pV1 = EdgeInsets.symmetric(vertical: dp1);
  static const pH1 = EdgeInsets.symmetric(horizontal: dp1);
  static const pV2 = EdgeInsets.symmetric(vertical: dp2);
  static const pH2 = EdgeInsets.symmetric(horizontal: dp2);
  static const pV4 = EdgeInsets.symmetric(vertical: dp4);
  static const pH4 = EdgeInsets.symmetric(horizontal: dp4);
  static const pV8 = EdgeInsets.symmetric(vertical: dp8);
  static const pH8 = EdgeInsets.symmetric(horizontal: dp8);
  static const pH12 = EdgeInsets.symmetric(horizontal: dp12);
  static const pV12 = EdgeInsets.symmetric(vertical: dp12);
  static const pV16 = EdgeInsets.symmetric(vertical: dp16);
  static const pH16 = EdgeInsets.symmetric(horizontal: dp16);
  static const pV20 = EdgeInsets.symmetric(vertical: dp20);
  static const pH20 = EdgeInsets.symmetric(horizontal: dp20);
  static const pV24 = EdgeInsets.symmetric(vertical: dp24);
  static const pH24 = EdgeInsets.symmetric(horizontal: dp24);
  static const pV32 = EdgeInsets.symmetric(vertical: dp32);
  static const pH32 = EdgeInsets.symmetric(horizontal: dp32);
  static const pH48 = EdgeInsets.symmetric(horizontal: dp48);
  static const pV48 = EdgeInsets.symmetric(vertical: dp48);
  static const pV64 = EdgeInsets.symmetric(vertical: dp64);
  static const pH64 = EdgeInsets.symmetric(horizontal: dp64);
  ...
  static EdgeInsets symmetric({double v = 0.0, double h = 0.0}) =>
  ...
  static void log(dynamic msg, {bool? hasDottedLine = true}) {
    if (!(kDebugMode || kProfileMode)) {
      return;
    }
    final String message = msg.toString();
    if (hasDottedLine == true) {
      debugPrint(
          '👇🏻┌------------------------------------------------------------------------------👨🏻‍💻');
    }
